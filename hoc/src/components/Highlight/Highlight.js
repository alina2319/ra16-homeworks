...
function ItemHighlightVideo(props) {
	return (
		<>
...
function ItemHighlightArticle(props) {
	return (
		<>
			<div className={'item-highlight__wrap'}>
...
function getContent(item) {
	const content = {
		video: <ItemHighlightVideo {...item} />,
		article: <ItemHighlightArticle {...item} />,
	}
...
function List(props) {
	return props.list.map((item, index) => <ItemHighlightWithLabel key={index} item={item} />);
};
